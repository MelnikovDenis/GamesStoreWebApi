...
namespace GamesStoreWebApi.Migrations
{
    ...
    [Migration("20230701001630_AddRootRoleAndCollectionTypes")]
    partial class AddRootRoleAndCollectionTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Collection", b =>
                {
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Discount", b =>
                {
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Game", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Key", b =>
                {
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Price", b =>
                {
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Purchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Collection", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.Game", "CollectionedGame")
                        .WithMany("Collections")
                        .HasForeignKey("CollectionedGameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamesStoreWebApi.Models.Entities.ApplicationUser", "Collectioner")
                        .WithMany("Collections")
                        .HasForeignKey("CollectionerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamesStoreWebApi.Models.Entities.CollectionType", "Type")
                        .WithMany("Collections")
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Discount", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.Game", "DiscountedGame")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Game", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.Company", "Developer")
                        .WithMany("DeveloperGames")
                        .HasForeignKey("DeveloperId");

                    b.HasOne("GamesStoreWebApi.Models.Entities.Company", "Publisher")
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Key", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.Game", "KeyGame")
                        .WithMany("Keys")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamesStoreWebApi.Models.Entities.Purchase", "KeyPurchase")
                        .WithMany("Keys")
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Price", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.Game", "PricedGame")
                        .WithMany("Prices")
            ...
            modelBuilder.Entity("GamesStoreWebApi.Models.Entities.Purchase", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.ApplicationUser", "Purchaser")
                        .WithMany("Purchases")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("GamesStoreWebApi.Models.Entities.ApplicationUser", null)
                        .WithMany()
